  ...
  if (worker->clsimported == clauses.num) {
    ...
    *cptr = 0;
    ...
    if (cls->count == nworkers) {
	  ...
	  clauses.first > clauses.num/(nworkers + 1)) gcls ();
    }
...
static void setopts (LGL * lgl, int i) {
  ...
  if (i) setopt (0, lgl, "bca", 0);	// TODO working?

  switch (i % 16) {
    case 0: default: break;
    case 1: setopt (i, lgl, "plain", 1); break;
    case 2: setopt (i, lgl, "block", 0), setopt (i, lgl, "cce", 0); break;
    case 3: setopt (i, lgl, "bias", -1); setopt (i, lgl, "prbrtc", 1); break;
    case 4: setopt (i, lgl, "acts", 0); break;
    case 5: setopt (i, lgl, "phase", 1); break;
    case 6: setopt (i, lgl, "acts", 1); break;
    case 7: setopt (i, lgl, "bias", 1); break;
    case 8:
      setopt (i, lgl, "wait", 0);
      setopt (i, lgl, "blkrtc", 1);
      setopt (i, lgl, "elmrtc", 1);
      break;
    case 9: setopt (i, lgl, "gluescale", 1); break;
    case 10: setopt (i, lgl, "gluescale", 3); break;
    case 11: setopt (i, lgl, "phase", -1); break;
    case 12: setopt (i, lgl, "restart", 0); break;
    case 13: setopt (i, lgl, "move", 1); break;
    case 14: setopt (i, lgl, "prbsimplertc", 1); break;
    case 15: setopt (i, lgl, "flipping", 1); break;
  }
...
int main (int argc, char ** argv) {
  ...
  for (i = 1; i < argc; i++) {
    ...
    if (!strcmp (argv[i], "-h")) {
      printf (
"usage: plingeling [ <option> ... ] [ <dimacs>[.gz|.bz2|.7z] ]\n"
"\n"
