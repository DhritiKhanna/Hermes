...
void table(int myrank, int nprocs){
	...
	while(i<3*(nprocs-1)) 
    {
        ...
        { ifs->storeInfo("stat.MPI_TAG",bo_eq,1,92,105,89); ifs->storeInfo("stat.MPI_TAG",bo_ne,2,107,120,89); // ifs->storeInfo("stat.MPI_TAG",bo_ne,3,123,146,89); 
        ...
        { ifs->storeInfo("stat.MPI_TAG",bo_ne,1,92,105,89); ifs->storeInfo("stat.MPI_TAG",bo_eq,2,107,120,89); //ifs->storeInfo("stat.MPI_TAG",bo_ne,3,123,146,89); 
            //If Request for forks
        ...
        { ifs->storeInfo("stat.MPI_TAG",bo_ne,1,92,105,89); ifs->storeInfo("stat.MPI_TAG",bo_ne,2,107,120,89); //ifs->storeInfo("stat.MPI_TAG",bo_eq,3,123,146,89); 
            //If Release of forks
		...
		} //else { ifs->storeInfo("stat.MPI_TAG",bo_ne,1,92,105,89); ifs->storeInfo("stat.MPI_TAG",bo_ne,2,107,120,89); ifs->storeInfo("stat.MPI_TAG",bo_ne,3,123,146,89); }
	}	
}