; ModuleID = '/home/dhriti/Desktop/Simple.cpp'
...
@.str = private unnamed_addr constant [8 x i8] c"Dhriti\0A\00", align 1
@.str.1 = private unnamed_addr constant [8 x i8] c"Hi all\0A\00", align 1
...
define i32 @_Z3erkii(i32 %a, i32 %b) #3 {
...
define i32 @main() #4 {
  ...
  %2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.2, i32 0, i32 0))
  call void @_Z3foov()
  %3 = call i32 @_Z3erkii(i32 1, i32 2)
  ret i32 0
}
